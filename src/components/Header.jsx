  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <img 
              ...
              alt="Logo" 
              className="h-1 w-1 rounded-full object-cover hover:scale-105 transition-all duration-300"
            />
            <div className="flex items-center space-x-4">
              <a 
        ...
        {/* Mobile Navigation */}
        <div className={`
          md:hidden fixed inset-0 bg-black/95 backdrop-blur-sm transition-all duration-300 
